...
class Selecao {
    ...
    public void insercao() {
        for (int i = 1; i < n; i++) {
            ...
            while ((j >= 0) && (compareDate(array[j], tmp) == 1)) {
                array[j + 1] = array[j];
                j--;
            }
     ...
     */
    private int compareDate(Jogador a, Jogador b) {

        if (a.getAnoNascimento() > b.getAnoNascimento())
            return 1;
        else if (a.getAnoNascimento() < b.getAnoNascimento())
            return -1;
        else
            return compareNome(a.getNome(), b.getNome());
...
public class TP02Q07 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File file = new File("633516_insercao.txt");
